-- Fix column names in fn_register_org_with_contact
-- Change phone -> contact_phone and email -> contact_email in INSERT statement
...
BEGIN
  ...
  -- FIX: Use contact_phone and contact_email (not phone/email)
