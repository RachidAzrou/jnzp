-- Fix kolom-mismatch: kvk_number → business_number voor alle org-types
-- Parameters met defaults moeten aan het einde
...
declare
  ...
  v_role text;
  v_ver_status text := case when p_set_active then 'ACTIVE' else 'PENDING' end;
