-- FORCE POSTGREST CACHE REFRESH: Recreate fn_seed_dossier_tasks_sql
-- Added comment to force PostgREST to detect changes: refresh_2025_01_11_v2
...
BEGIN
  -- Refresh 2025-01-11 v2: Removed created_by reference
  ...
  -- Insert tasks with correct types and Dutch status values
...
-- Force a schema change notification
