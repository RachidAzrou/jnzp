-- Step 2: Add role_scope and remaining tables
-- Add role_scope to user_roles for platform vs org level permissions
...
-- Enhanced audit_events with better structure
...
-- Update audit_events RLS to allow platform admins full access
...
-- Update existing organizations to ACTIVE status
...
-- Add organization contacts table
