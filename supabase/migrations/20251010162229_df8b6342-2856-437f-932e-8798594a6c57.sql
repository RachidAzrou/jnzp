-- FINAL FIX: Verwijder DELETE helemaal, alleen UPSERT gebruiken
...
BEGIN
  ...
  -- CRITICAL FIX: GEEN DELETE MEER! Alleen UPSERT (voorkomt trigger corruption)
  -- UPSERT primary role - atomisch en veilig
  ...
  -- UPSERT org_admin role - ook atomisch en veilig
