    ...
    Tables: {
      ...
      claims: {
        Row: {
          ...
          api_retry_scheduled_at: string | null
          blocked_reason: string | null
          created_at: string
          dossier_id: string
          id: string
          insurer_org_id: string
          manual_verification_document_url: string | null
      ...
      dossiers: {
        Row: {
          ...
          policy_needs_recheck: boolean | null
          policy_verification_method: string | null
          policy_verified_at: string | null
          policy_verified_by: string | null
          ref_number: string
          require_doc_ref: string | null
          status: Database["public"]["Enums"]["simple_dossier_status"]
          updated_at: string
        }
        Insert: {
          adhoc_fd_org_id?: string | null
